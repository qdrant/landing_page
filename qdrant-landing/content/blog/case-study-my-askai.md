...
"When we double clicked on our users, the stickiest users and the ones generating the most revenue, we saw that pretty much all of them were using it in a customer support use case," explains Alex, co-founder of My AskAI. "So we thought, there's something interesting happening here. Let's focus on this niche."
...
>"Scaling horizontally or vertically is like two clicks away. It's not really a concern we have. If we notice anything, we get the alert, and we can jump in and scale things up or down as we need to." Alex Rainey - CTO - My AskAI
...
>"Just being able to turn on hybrid search is super useful. It removes that headache and pushes management of hybrid search down to the vendor." Alex Rainey - CTO - My AskAI
...
"Qdrant support is always phenomenal. Super fast, super technical, very hands on. We've always had great experiences whenever we needed them." Alex, My AskAI
