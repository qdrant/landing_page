...
This tutorial shows you how to build and deploy your own [hybrid search](/articles/hybrid-search/) service to look through descriptions of companies from [startups-list.com](https://www.startups-list.com/) and pick the most similar ones to your query.
...
[Fastembed](/articles/fastembed/) natively integrates with Qdrant client, so you can easily upload the data into Qdrant and perform search queries.
