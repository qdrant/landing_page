...
[Fastembed](https://qdrant.tech/articles/fastembed/) natively integrates with Qdrant client, so you can easily upload the data into Qdrant and perform search queries.
