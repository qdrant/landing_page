...
- title: A Node is CPU Throttled
  content: |
    ...
    **Where can I learn more about this alert?**
    ...
    Learn about how to optimizer Qdrant for performance and how to configure indexing [here](/documentation/manage-data/indexing/) and [here](/documentation/operations/optimize/).
