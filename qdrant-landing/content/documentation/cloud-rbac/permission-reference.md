...
> 💡 When enabling `write:*` permissions in the UI, the corresponding `read:*` permission will also be enabled. This guarantees access to resources after creating and/or updating them.
