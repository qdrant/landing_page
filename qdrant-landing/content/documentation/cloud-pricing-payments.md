...
Note: If you choose to pay your Qdrant Cloud clusters through a cloud provider marketplace, Qdrant Cluster creation is limited to paid clusters in regions of this cloud provider only. This is due to cloud provider compliance requirements. If you wish to run clusters in other regions or on other cloud providers, you can create additional accounts using a different payment method.
