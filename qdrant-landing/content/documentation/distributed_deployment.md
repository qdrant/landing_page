...
To enable distributed deployment - enable the cluster mode in the [configuration](/documentation/configuration-ops/configuration/) or using the ENV variable: `QDRANT__CLUSTER__ENABLED=true`.
