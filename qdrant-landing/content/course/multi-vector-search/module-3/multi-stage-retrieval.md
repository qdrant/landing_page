...
Using `models.Document` lets Qdrant handle all embedding on the server side, simplifying your client code and ensuring consistency between indexing and querying.
