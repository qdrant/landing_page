...
Qdrant stores data as **points** — each point is a vector combined with an optional payload (structured metadata). This section covers how to write, update, and move data in your collections.
