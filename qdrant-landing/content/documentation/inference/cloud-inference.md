...
Inference of short payloads, such as most search queries, is handled locally in the same network as the Qdrant Cloud cluster, reducing latency for search inputs. This applies to  Qdrant-hosted models and is fully transparent. Longer search inputs and upserts are handled by a dedicated remote inference service.
