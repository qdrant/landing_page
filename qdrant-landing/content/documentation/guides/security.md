...
- **JWT Signature** - The signature is generated by base-64-url-encoding the header and payload, concatenating them with a `.`, and signing them with the `api_key` using the `HS256` algorithm.
