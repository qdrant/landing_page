---
label: IN PRODUCTION
title: Customers Building with Qdrant Cloud
cards:
  - id: 0
    icon:
      src: /img/customer-logo/tripadvisor.svg
      alt: Tripadvisor logo
    title: <span>2-3x</span> Revenue Lift
  ...
  - id: 1
    icon:
      ...
      alt: Telekom logo
    title: <span>7x Faster</span> Production Time
  ...
  - id: 2
    icon:
      ...
      alt: Faz logo
    title: <span><1s</span> Filtered query response on <span>14M vectors</span>
