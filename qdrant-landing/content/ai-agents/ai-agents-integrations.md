...
- id: 0
  icon:
    src: /img/integrations/icons/integration-lang-graph.svg
    alt: LangGraph logo
  title: LangGraph
...
- id: 2
  icon:
    src: /img/integrations/icons/integration-crew-ai.svg
    alt: Crew AI logo
  title: CrewAI
...
- id: 3
  icon:
    src: /img/integrations/icons/integration-auto-gen.svg
    alt: AutoGen logo
  title: AutoGen
