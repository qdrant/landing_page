...
* **Topology Aware Multi-AZ Setup**: Premium customers can deploy their clusters across multiple availability zones for higher availability and resilience. This guarantees a **99.95% uptime SLA** for Multi-AZ clusters. Multi-AZ is independent of replication factor; see [Multi-AZ vs. replication factor](/documentation/scaling/horizontal-scaling/#multi-az-vs-replication-factor) for the distinction.
