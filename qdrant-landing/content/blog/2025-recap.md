...
• [Inline Storage](https://qdrant.tech/documentation/optimization/optimize/#inline-storage-in-hnsw-index) embedded quantized vectors directly into the graph to dramatically improve disk-based search performance  
...
• [Incremental HNSW indexing](https://qdrant.tech/documentation/tutorials-develop/bulk-upload/?q=incremental+hnsw#choose-an-indexing-strategy) for upsert-heavy workloads  
