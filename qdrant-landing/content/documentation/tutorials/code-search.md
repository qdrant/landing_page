...
|--------------------|---------------------|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| toc                | point_ops.rs        | 0.59448624 | [Link to code starting with `pub async fn count`](https://github.com/qdrant/qdrant/blob/3fbe1cae6cb7f51a0c5bb4b45cfe6749ac76ed59/lib/storage/src/content_manager/toc/point_ops.rs#L121-L127) |
| operations         | types.rs            | 0.5493385  | [Link to code starting with `///Count Request`](https://github.com/qdrant/qdrant/blob/3fbe1cae6cb7f51a0c5bb4b45cfe6749ac76ed59/lib/collection/src/operations/types.rs#L879-L892) |
| collection_manager | segments_updater.rs | 0.5121002  | [Link to code starting with `pub(crate)`](https://github.com/qdrant/qdrant/blob/3fbe1cae6cb7f51a0c5bb4b45cfe6749ac76ed59/lib/collection/src/collection_manager/segments_updater.rs#L382-L388) |
| collection         | point_ops.rs        | 0.5063539  | [Link to code starting with `async fn count`](https://github.com/qdrant/qdrant/blob/3fbe1cae6cb7f51a0c5bb4b45cfe6749ac76ed59/lib/collection/src/collection/point_ops.rs#L331-L336) |
| map_index          | mod.rs              | 0.49973983 | [Link to code starting with `fn get_points_with_value_count`](https://github.com/qdrant/qdrant/blob/3fbe1cae6cb7f51a0c5bb4b45cfe6749ac76ed59/lib/segment/src/index/field_index/map_index/mod.rs#L89-L93) |
...
| module             | file_name                  | score      | signature                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|--------------------|----------------------------|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| toc                | point_ops.rs               | 0.59448624 | [Link to code starting with `async fn count`](https://github.com/qdrant/qdrant/blob/3fbe1cae6cb7f51a0c5bb4b45cfe6749ac76ed59/lib/storage/src/content_manager/toc/point_ops.rs#L121-L127)
| operations         | types.rs                   | 0.5493385  | [Link to code starting with `///Count Request`](https://github.com/qdrant/qdrant/blob/3fbe1cae6cb7f51a0c5bb4b45cfe6749ac76ed59/lib/collection/src/operations/types.rs#L879-L892) |
| collection_manager | segments_updater.rs   | 0.5121002  | [Link to code starting with `pub(crate)`](https://github.com/qdrant/qdrant/blob/3fbe1cae6cb7f51a0c5bb4b45cfe6749ac76ed59/lib/collection/src/collection_manager/segments_updater.rs#L382-L388) |
| collection         | point_ops.rs               | 0.5063539  | [Link to code starting with `async fn count`](https://github.com/qdrant/qdrant/blob/3fbe1cae6cb7f51a0c5bb4b45cfe6749ac76ed59/lib/collection/src/collection/point_ops.rs#L331-L336) |
| map_index          | mod.rs                     | 0.49973983 | [Link to code starting with `fn get_points_with_value_count`](https://github.com/qdrant/qdrant/blob/3fbe1cae6cb7f51a0c5bb4b45cfe6749ac76ed59/lib/segment/src/index/field_index/map_index/mod.rs#L89-L93) |
