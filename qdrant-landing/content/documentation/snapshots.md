...
The target directory can be controlled through the [configuration](/documentation/configuration-ops/configuration/):
...
configure it in the [configuration](/documentation/configuration-ops/configuration/) file.
