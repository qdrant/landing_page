...
* `idf` - which population sparse vector IDF statistics are computed over. See [Per-Tenant IDF Statistics](/documentation/manage-data/multitenancy/#per-tenant-idf-statistics).
