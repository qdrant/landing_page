...
such as Qdrant](https://qdrant.tech/), is of great help here, as their ability to perform a [semantic search](https://qdrant.tech/documentation/tutorials-basics/search-beginners/) over a huge knowledge base is crucial to preselect some possibly valid 
