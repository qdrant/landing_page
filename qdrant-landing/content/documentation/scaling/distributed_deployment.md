...
> Aside: Advanced use cases such as multitenancy may require an uneven distribution of shards. See [Multitenancy](/documentation/production-patterns/multitenant-search/).
