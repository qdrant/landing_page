...
Treat a loss at 10 candidates as a model-fit check before you increase candidate depth. Check the context window, query and document lengths, language, and training domain.<br>
All three models tested here truncate the query and document together at 512 tokens, and none was trained on these domains.
