...
| **Namespace**  | [**User-defined sharding**](../../guides/distributed_deployment/#user-defined-sharding) | Namespaces allow the partitioning of the vectors in an index into subsets. Qdrant features user-defined sharding for this, which is more featureful as operations can be over multiple shards.                                                                                 |
