...
<aside role="status">Using Docker/WSL on Windows with mounts is known to have file system problems causing data loss. See <a href="/documentation/common-errors/#incompatible-file-system">troubleshooting</a>.</aside>

### Networking

Each Qdrant instance requires three open ports:

* `6333` - For the HTTP API, for the [Monitoring](/documentation/monitoring-telemetry/monitoring/) health and metrics endpoints
...
* To integrate Qdrant with your [monitoring](/documentation/monitoring-telemetry/monitoring/) and logging solutions
...
For more information, see the [Configuration](/documentation/configuration-ops/configuration/) documentation.
