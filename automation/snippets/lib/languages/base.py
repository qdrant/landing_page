...
class CompileResult:
    ...
    """
    Mapping from the snippet filename to the command that runs the snippet.
    """

    has_issues: bool = False
    """
    If true, indicates that there were issues during compilation/typechecking,
    but the snippets can still be run.
    """
