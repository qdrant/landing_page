...
short_description: "Module 5 of the Qdrant Beginner Course: what the module covers and the path through it."
...
1. [Project Overview](/course/beginners/module-5/project-overview/)
2. [System Architecture](/course/beginners/module-5/system-architecture/)
3. [Signal Sources and Embedding Models](/course/beginners/module-5/signal-sources-and-embedding-models/)
4. [Ingestion Pipeline](/course/beginners/module-5/ingestion-pipeline/)
5. [Clustering Risk Signals](/course/beginners/module-5/clustering-risk-signals/)
6. [Analyst Queries](/course/beginners/module-5/analyst-queries/)
7. [Knowledge Check](/course/beginners/module-5/knowledge-check/)
8. [Course Summary](/course/beginners/module-5/course-summary/)
9. [References and Further Reading](/course/beginners/module-5/references-and-further-reading/)
