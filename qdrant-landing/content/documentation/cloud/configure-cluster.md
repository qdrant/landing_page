...
The cloud platform does not expose all [configuration options](/documentation/configuration-ops/configuration/) available in Qdrant. We have selected the relevant options that are explained in detail below.
...
Refer to [Qdrant Configuration](/documentation/configuration-ops/configuration/#configuration-options) for more details.
