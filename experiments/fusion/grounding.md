...
| The `ndcg_at_k` the article prints scores every SciFact query exactly as `pytrec_eval` does | `test_article_ndcg.py`, which executes the code block out of the markdown. 300 queries, worst per-query difference 0.0, both means 0.7175 |
