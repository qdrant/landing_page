...
| [OpenTelemetry End-to-End](/documentation/tutorials-build-essentials/opentelemetry-end-to-end/) | Send Qdrant Cloud metrics to your OTel backend and correlate a slow trace. | <span class="pill">Python</span> <span class="pill">Docker</span> | 45m | <span class="text-yellow">Intermediate</span> |
| [Video Anomaly Detection Part 1](/documentation/tutorials-build-essentials/video-anomaly-edge-part-1/) | Architecture, Twelve Labs, and NVIDIA VSS integration. | <span class="pill">Python</span> | 90m | <span class="text-red">Advanced</span> |
...
| [Video Anomaly Detection Part 3](/documentation/tutorials-build-essentials/video-anomaly-edge-part-3/) | Scoring, baseline governance, and deployment on Vultr. | <span class="pill">Python</span> | 90m | <span class="text-red">Advanced</span> |
