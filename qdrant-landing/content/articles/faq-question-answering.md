...
>If you want to learn more about similarity learning and applications, check out this [article](/documentation/tutorials-basics/neural-search/) which might be an asset.
